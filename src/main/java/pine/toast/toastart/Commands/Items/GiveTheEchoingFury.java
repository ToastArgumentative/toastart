...
public class GiveTheEchoingFury implements CommandExecutor {
    @Override
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        if (args.length < 2) {
            sender.sendMessage("Usage: /giveTheEchoingFury [playerName] <rarity>");
            return true;
        }
        ...
        if (args.length == 2) {
            ...
            try {
                switch (rarity) {
                    case COMMON:
                        player.getInventory().addItem(BarbarianItems.getEchoingFuryCommon());
                        break;
                    case UNCOMMON:
                        player.getInventory().addItem(BarbarianItems.getEchoingFuryUncommon());
                        break;
                    case RARE:
                        player.getInventory().addItem(BarbarianItems.getEchoingFuryRare());
                        break;
                    case EPIC:
                        player.getInventory().addItem(BarbarianItems.getEchoingFuryEpic());
                        break;
                    case LEGENDARY:
                        player.getInventory().addItem(BarbarianItems.getEchoingFuryLegendary());
                        break;
                }
            } catch (Exception e) {
            ...
            try {
                ...
                if (targetPlayer != null) {
                    ...
                    switch (rarity) {
                        case COMMON:
                            targetPlayer.getInventory().addItem(BarbarianItems.getEchoingFuryCommon());
                            break;
                        case UNCOMMON:
                            targetPlayer.getInventory().addItem(BarbarianItems.getEchoingFuryUncommon());
                            break;
                        case RARE:
                            targetPlayer.getInventory().addItem(BarbarianItems.getEchoingFuryRare());
                            break;
                        case EPIC:
                            targetPlayer.getInventory().addItem(BarbarianItems.getEchoingFuryEpic());
                            break;
                        case LEGENDARY:
                            targetPlayer.getInventory().addItem(BarbarianItems.getEchoingFuryLegendary());
                            break;
                    }
                } else {
